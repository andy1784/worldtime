#!/usr/bin/env python3
"""Generate es, zh, it, de translations of the new blog post."""
import os
...
META_DATE = {
    'es': '10 ago 2026', 'zh': '2026年8月10日', 'it': '10 ago 2026', 'de': '10. Aug 2026',
}
META_READ = {
    'es': '8 min de lectura', 'zh': '阅读 8 分钟', 'it': '8 min di lettura', 'de': '8 Min. Lesezeit',
}
...
'time-zone-abbreviations-cheat-sheet': {
 'es': ('Hoja de referencia de abreviaturas de zonas horarias (2026)',
   'Referencia rápida para todas las abreviaturas principales de zonas horarias: EST, PST, CET, IST, JST y 50 más. Incluye desfases UTC, variantes de horario de verano y las ciudades que usan cada una.',
   'abreviaturas de zonas horarias, EST PST CST MST, hoja de trucos desfases UTC, lista de códigos de zona horaria, acrónimos de zona horaria, abreviaturas de horario de verano',
   'Hoja de referencia de abreviaturas de zonas horarias',
   '''<p>Ves "EST" en una confirmación de vuelo, "CET" en una invitación de reunión, "IST" en un archivo de log. Cada abreviatura significa un desfase específico de UTC, pero algunas significan cosas distintas en verano versus invierno. Esta hoja de referencia te da el desfase exacto, las ciudades principales y si el horario de verano lo cambia.</p>

<h2>Zonas Horarias de Norteamérica</h2>
<table class="tz-table">
    <thead><tr><th>Abr</th><th>Nombre Completo</th><th>Desfase UTC</th><th>Variante Horario de Verano</th><th>Ciudades Principales</th></tr></thead>
    <tbody>
        <tr><td>EST</td><td>Eastern Standard Time</td><td>UTC-5</td><td>EDT (UTC-4)</td><td>Nueva York, Toronto, Miami, Atlanta</td></tr>
        ...
        <tr><td>HST</td><td>Hawaii-Aleutian Standard Time</td><td>UTC-10</td><td>Sin horario de verano</td><td>Honolulu, Hilo, Adak</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abr</th><th>Nombre Completo</th><th>Desfase UTC</th><th>Variante Horario de Verano</th><th>Ciudades Principales</th></tr></thead>
    <tbody>
        <tr><td>AST</td><td>Atlantic Standard Time</td><td>UTC-4</td><td>ADT (UTC-3)</td><td>Halifax, San Juan, Bermudas, Caracas</td></tr>
...
<table class="tz-table">
    <thead><tr><th>Abr</th><th>Nombre Completo</th><th>Desfase UTC</th><th>Variante Horario de Verano</th><th>Ciudades Principales</th></tr></thead>
    <tbody>
        <tr><td>GMT</td><td>Greenwich Mean Time</td><td>UTC+0</td><td>BST (UTC+1)</td><td>Londres, Dublín, Lisboa (invierno)</td></tr>
        ...
        <tr><td>WAT</td><td>West Africa Time</td><td>UTC+1</td><td>Sin horario de verano</td><td>Lagos, Kinshasa, Argel</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abr</th><th>Nombre Completo</th><th>Desfase UTC</th><th>Variante Horario de Verano</th><th>Ciudades Principales</th></tr></thead>
    <tbody>
        <tr><td>GST</td><td>Gulf Standard Time</td><td>UTC+4</td><td>Sin horario de verano</td><td>Dubái, Abu Dabi, Mascate, Doha</td></tr>
        ...
        <tr><td>PKT</td><td>Pakistan Standard Time</td><td>UTC+5</td><td>Sin horario de verano</td><td>Karachi, Lahore, Islamabad</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abr</th><th>Nombre Completo</th><th>Desfase UTC</th><th>Variante Horario de Verano</th><th>Ciudades Principales</th></tr></thead>
    <tbody>
        <tr><td>IST</td><td>India Standard Time</td><td>UTC+5:30</td><td>Sin horario de verano</td><td>Mumbai, Delhi, Bangalore, Kolkata, Chennai</td></tr>
        ...
        <tr><td>SGT</td><td>Singapore Time</td><td>UTC+8</td><td>Sin horario de verano</td><td>Singapur, Kuala Lumpur, Manila, Perth</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abr</th><th>Nombre Completo</th><th>Desfase UTC</th><th>Variante Horario de Verano</th><th>Ciudades Principales</th></tr></thead>
    <tbody>
        <tr><td>JST</td><td>Japan Standard Time</td><td>UTC+9</td><td>Sin horario de verano</td><td>Tokio, Osaka, Seúl*, Pionyang*</td></tr>
...
<ul>
    <li><strong>CST</strong> — Central Standard Time (UTC-6, Norteamérica) <em>o</em> China Standard Time (UTC+8) <em>o</em> Cuba Standard Time (UTC-5)</li>
    ...
    <li><strong>AST</strong> — Atlantic Standard Time (UTC-4) <em>o</em> Arabia Standard Time (UTC+3) <em>o</em> Amazon Standard Time (UTC-4, Brasil)</li>
</ul>
...
<ul>
    <li><strong>Norteamérica</strong>: 2.º domingo de marzo → 1.er domingo de noviembre</li>
    ...
    <li><strong>Paraguay</strong>: 1.er domingo de octubre → último domingo de marzo</li>
</ul>
...
'''),
 'zh': ('时区缩写速查表 (2026)',
   '主要时区缩写的快速参考——EST、PST、CET、IST、JST 及 50 多个其他。包含 UTC 偏移、夏令时变体及使用各缩写的城市。',
   '时区缩写,EST PST CST MST,UTC 偏移速查表,时区代码列表,时区首字母缩写,夏令时缩写',
   '时区缩写速查表',
   '''<p>你在航班确认单上看到"EST",会议邀请里看到"CET",日志文件里看到"IST"。每个缩写都代表一个具体的 UTC 偏移,但有些在夏冬季意义不同。这张速查表给你确切偏移、主要城市,以及夏令时是否会改变它。</p>

<h2>北美时区</h2>
<table class="tz-table">
    <thead><tr><th>缩写</th><th>全称</th><th>UTC 偏移</th><th>夏令时变体</th><th>主要城市</th></tr></thead>
    <tbody>
        <tr><td>EST</td><td>Eastern Standard Time</td><td>UTC-5</td><td>EDT (UTC-4)</td><td>纽约、多伦多、迈阿密、亚特兰大</td></tr>
        ...
        <tr><td>HST</td><td>Hawaii-Aleutian Standard Time</td><td>UTC-10</td><td>无夏令时</td><td>檀香山、希洛、阿达克</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>缩写</th><th>全称</th><th>UTC 偏移</th><th>夏令时变体</th><th>主要城市</th></tr></thead>
    <tbody>
        <tr><td>AST</td><td>Atlantic Standard Time</td><td>UTC-4</td><td>ADT (UTC-3)</td><td>哈利法克斯、圣胡安、百慕大、加拉加斯</td></tr>
        ...
        <tr><td>CLT</td><td>Chile Standard Time</td><td>UTC-4</td><td>CLST (UTC-3)</td><td>圣地亚哥、瓦尔帕莱索、康塞普西翁</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>缩写</th><th>全称</th><th>UTC 偏移</th><th>夏令时变体</th><th>主要城市</th></tr></thead>
    <tbody>
        <tr><td>GMT</td><td>Greenwich Mean Time</td><td>UTC+0</td><td>BST (UTC+1)</td><td>伦敦、都柏林、里斯本(冬季)</td></tr>
        ...
        <tr><td>WAT</td><td>West Africa Time</td><td>UTC+1</td><td>无夏令时</td><td>拉各斯、金沙萨、阿尔及尔</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>缩写</th><th>全称</th><th>UTC 偏移</th><th>夏令时变体</th><th>主要城市</th></tr></thead>
    <tbody>
        <tr><td>GST</td><td>Gulf Standard Time</td><td>UTC+4</td><td>无夏令时</td><td>迪拜、阿布扎比、马斯喀特、多哈</td></tr>
        ...
        <tr><td>PKT</td><td>Pakistan Standard Time</td><td>UTC+5</td><td>无夏令时</td><td>卡拉奇、拉合尔、伊斯兰堡</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>缩写</th><th>全称</th><th>UTC 偏移</th><th>夏令时变体</th><th>主要城市</th></tr></thead>
    <tbody>
        <tr><td>IST</td><td>India Standard Time</td><td>UTC+5:30</td><td>无夏令时</td><td>孟买、德里、班加罗尔、加尔各答、金奈</td></tr>
        ...
        <tr><td>SGT</td><td>Singapore Time</td><td>UTC+8</td><td>无夏令时</td><td>新加坡、吉隆坡、马尼拉、珀斯</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>缩写</th><th>全称</th><th>UTC 偏移</th><th>夏令时变体</th><th>主要城市</th></tr></thead>
    <tbody>
        <tr><td>JST</td><td>Japan Standard Time</td><td>UTC+9</td><td>无夏令时</td><td>东京、大阪、首尔*、平壤*</td></tr>
        ...
        <tr><td>NZST</td><td>New Zealand Standard Time</td><td>UTC+12</td><td>NZDT (UTC+13)</td><td>奥克兰、惠灵顿、克赖斯特彻奇</td></tr>
    </tbody>
</table>
...
<ul>
    <li><strong>CST</strong> — Central Standard Time (UTC-6,北美) <em>或</em> China Standard Time (UTC+8) <em>或</em> Cuba Standard Time (UTC-5)</li>
    ...
    <li><strong>AST</strong> — Atlantic Standard Time (UTC-4) <em>或</em> Arabia Standard Time (UTC+3) <em>或</em> Amazon Standard Time (UTC-4,巴西)</li>
</ul>
<p>看到歧义代码时,查看旁边的国家或城市名。要精确换算,请用我们的 <a href="/zh/time-zone-converter.html">时区转换器</a>,它能正确处理所有这些情况。</p>

<h2>快速参考:夏令时切换日期(典型)</h2>
<ul>
    <li><strong>北美</strong>:3月第2个周日→11月第1个周日</li>
    ...
    <li><strong>巴拉圭</strong>:10月第1个周日→3月最后一个周日</li>
</ul>
...
'''),
 'it': ('Scheda di riferimento per le abbreviazioni dei fusi orari (2026)',
   'Riferimento rapido per tutte le principali abbreviazioni dei fusi orari - EST, PST, CET, IST, JST e 50 altre. Include offset UTC, varianti ora legale e le città che usano ciascuna.',
   'abbreviazioni fusi orari, EST PST CST MST, foglio trucco offset UTC, lista codici fuso orario, acronimi fuso orario, abbreviazioni ora legale',
   'Scheda di riferimento per le abbreviazioni dei fusi orari',
   '''<p>Vedi "EST" su una conferma di volo, "CET" in un invito a una riunione, "IST" in un file di log. Ogni abbreviazione significa un offset specifico da UTC, ma alcune significano cose diverse d'estate versus d'inverno. Questa scheda ti dà l'offset esatto, le città principali e se l'ora legale lo sposta.</p>

<h2>Fusi Orari Nordamericani</h2>
<table class="tz-table">
    <thead><tr><th>ABBREV</th><th>Nome Completo</th><th>Offset UTC</th><th>Variante Ora Legale</th><th>Città Principali</th></tr></thead>
    <tbody>
        ...
        <tr><td>AKST</td><td>Alaska Standard Time</td><td>UTC-9</td><td>AKDT (UTC-8)</td><td>Anchorage, Fairbanks, Juneau</td></tr>
        <tr><td>HST</td><td>Hawaii-Aleutian Standard Time</td><td>UTC-10</td><td>Nessuna ora legale</td><td>Honolulu, Hilo, Adak</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>ABBREV</th><th>Nome Completo</th><th>Offset UTC</th><th>Variante Ora Legale</th><th>Città Principali</th></tr></thead>
    <tbody>
        <tr><td>GMT</td><td>Greenwich Mean Time</td><td>UTC+0</td><td>BST (UTC+1)</td><td>Londra, Dublino, Lisbona (inverno)</td></tr>
        ...
        <tr><td>WAT</td><td>West Africa Time</td><td>UTC+1</td><td>Nessuna ora legale</td><td>Lagos, Kinshasa, Algeri</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>ABBREV</th><th>Nome Completo</th><th>Offset UTC</th><th>Variante Ora Legale</th><th>Città Principali</th></tr></thead>
    <tbody>
        <tr><td>GST</td><td>Gulf Standard Time</td><td>UTC+4</td><td>Nessuna ora legale</td><td>Dubai, Abu Dhabi, Muscat, Doha</td></tr>
        ...
        <tr><td>PKT</td><td>Pakistan Standard Time</td><td>UTC+5</td><td>Nessuna ora legale</td><td>Karachi, Lahore, Islamabad</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>ABBREV</th><th>Nome Completo</th><th>Offset UTC</th><th>Variante Ora Legale</th><th>Città Principali</th></tr></thead>
    <tbody>
        <tr><td>IST</td><td>India Standard Time</td><td>UTC+5:30</td><td>Nessuna ora legale</td><td>Mumbai, Delhi, Bangalore, Kolkata, Chennai</td></tr>
        ...
        <tr><td>SGT</td><td>Singapore Time</td><td>UTC+8</td><td>Nessuna ora legale</td><td>Singapore, Kuala Lumpur, Manila, Perth</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>ABBREV</th><th>Nome Completo</th><th>Offset UTC</th><th>Variante Ora Legale</th><th>Città Principali</th></tr></thead>
    <tbody>
        <tr><td>JST</td><td>Japan Standard Time</td><td>UTC+9</td><td>Nessuna ora legale</td><td>Tokyo, Osaka, Seul*, Pyongyang*</td></tr>
...
<ul>
    <li><strong>CST</strong> — Central Standard Time (UTC-6, Nord America) <em>o</em> China Standard Time (UTC+8) <em>o</em> Cuba Standard Time (UTC-5)</li>
    ...
    <li><strong>PST</strong> — Pacific Standard Time (UTC-8) <em>或</em> Philippine Standard Time (UTC+8)</li>
    <li><strong>BST</strong> — British Summer Time (UTC+1) <em>o</em> Bangladesh Standard Time (UTC+6) <em>o</em> Bougainville Standard Time (UTC+11)</li>
    <li><strong>AST</strong> — Atlantic Standard Time (UTC-4) <em>o</em> Arabia Standard Time (UTC+3) <em>o</em> Amazon Standard Time (UTC-4, Brasile)</li>
</ul>
...
<ul>
    <li><strong>Nord America</strong>: 2ª domenica di marzo → 1ª domenica di novembre</li>
    ...
    <li><strong>Paraguay</strong>: 1ª domenica di ottobre → ultima domenica di marzo</li>
</ul>
...
'''),
 'de': ('Zeitzone-Abkürzungen Spickzettel (2026)',
   'Schnellreferenz für alle wichtigen Zeitzonen-Abkürzungen — EST, PST, CET, IST, JST und 50 mehr. Enthält UTC-Offsets, Sommerzeit-Varianten und die Städte, die jede nutzen.',
   'zeitzonen-abkürzungen, EST PST CST MST, UTC-offsets spickzettel, zeitzonen-codes liste, zeitzonen-akronyme, sommerzeit-abkürzungen',
   'Zeitzone-Abkürzungen Spickzettel',
   '''<p>Du siehst "EST" auf einer Flugbestätigung, "CET" in einer Meeting-Einladung, "IST" in einer Log-Datei. Jede Abkürzung steht für einen spezifischen Offset zu UTC, aber manche bedeuten im Sommer etwas anderes als im Winter. Dieser Spickzettel gibt dir den exakten Offset, die Hauptstädte und ob die Sommerzeit ihn verschiebt.</p>

<h2>Nordamerikanische Zeitzonen</h2>
<table class="tz-table">
    <thead><tr><th>Abk.</th><th>Vollständiger Name</th><th>UTC-Offset</th><th>Sommerzeit-Variante</th><th>Hauptstädte</th></tr></thead>
    <tbody>
        <tr><td>EST</td><td>Eastern Standard Time</td><td>UTC-5</td><td>EDT (UTC-4)</td><td>New York, Toronto, Miami, Atlanta</td></tr>
        ...
        <tr><td>AKST</td><td>Alaska Standard Time</td><td>UTC-9</td><td>AKDT (UTC-8)</td><td>Anchorage, Fairbanks, Juneau</td></tr>
        <tr><td>HST</td><td>Hawaii-Aleutian Standard Time</td><td>UTC-10</td><td>Keine Sommerzeit</td><td>Honolulu, Hilo, Adak</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abk.</th><th>Vollständiger Name</th><th>UTC-Offset</th><th>Sommerzeit-Variante</th><th>Hauptstädte</th></tr></thead>
    <tbody>
        <tr><td>GMT</td><td>Greenwich Mean Time</td><td>UTC+0</td><td>BST (UTC+1)</td><td>London, Dublin, Lissabon (Winter)</td></tr>
        ...
        <tr><td>WAT</td><td>West Africa Time</td><td>UTC+1</td><td>Keine Sommerzeit</td><td>Lagos, Kinshasa, Algier</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abk.</th><th>Vollständiger Name</th><th>UTC-Offset</th><th>Sommerzeit-Variante</th><th>Hauptstädte</th></tr></thead>
    <tbody>
        <tr><td>GST</td><td>Gulf Standard Time</td><td>UTC+4</td><td>Keine Sommerzeit</td><td>Dubai, Abu Dhabi, Maskat, Doha</td></tr>
        ...
        <tr><td>PKT</td><td>Pakistan Standard Time</td><td>UTC+5</td><td>Keine Sommerzeit</td><td>Karachi, Lahore, Islamabad</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abk.</th><th>Vollständiger Name</th><th>UTC-Offset</th><th>Sommerzeit-Variante</th><th>Hauptstädte</th></tr></thead>
    <tbody>
        <tr><td>IST</td><td>India Standard Time</td><td>UTC+5:30</td><td>Keine Sommerzeit</td><td>Mumbai, Delhi, Bangalore, Kolkata, Chennai</td></tr>
        ...
        <tr><td>SGT</td><td>Singapore Time</td><td>UTC+8</td><td>Keine Sommerzeit</td><td>Singapur, Kuala Lumpur, Manila, Perth</td></tr>
    </tbody>
</table>
...
<table class="tz-table">
    <thead><tr><th>Abk.</th><th>Vollständiger Name</th><th>UTC-Offset</th><th>Sommerzeit-Variante</th><th>Hauptstädte</th></tr></thead>
    <tbody>
        <tr><td>JST</td><td>Japan Standard Time</td><td>UTC+9</td><td>Keine Sommerzeit</td><td>Tokio, Osaka, Seoul*, Pjöngjang*</td></tr>
...
<ul>
    <li><strong>CST</strong> — Central Standard Time (UTC-6, Nordamerika) <em>oder</em> China Standard Time (UTC+8) <em>oder</em> Cuba Standard Time (UTC-5)</li>
    ...
    <li><strong>AST</strong> — Atlantic Standard Time (UTC-4) <em>oder</em> Arabia Standard Time (UTC+3) <em>oder</em> Amazon Standard Time (UTC-4, Brasilien)</li>
</ul>
...
<ul>
    <li><strong>Nordamerika</strong>: 2. Sonntag März → 1. Sonntag November</li>
    ...
    <li><strong>Paraguay</strong>: 1. Sonntag Oktober → Letzter Sonntag März</li>
</ul>
